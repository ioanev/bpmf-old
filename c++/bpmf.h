...
typedef Eigen::Matrix<double, num_latent * num_latent, Eigen::Dynamic> MatrixNNXd;
typedef Eigen::Matrix<double, num_latent, 1> VectorNd;
typedef Eigen::Matrix<double, num_latent * num_latent, 1> VectorNNd;
typedef Eigen::Map<MatrixNXd, Eigen::Aligned> MapNXd;
typedef Eigen::Map<MatrixNNXd, Eigen::Aligned> MapNNXd;
